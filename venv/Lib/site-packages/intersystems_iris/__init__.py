...
class IRIS(_IRIS._IRIS):
    """ deprecated. use Iris instead. """

class Iris(_IRISWrapper.Iris):
    pass

class IrisGlobal(_IRISWrapper.IrisGlobal):
    pass

class IrisTransaction(_IRISWrapper.IrisTransaction):
    pass

class IrisSlicer(_IRISWrapper.IrisSlicer):
    pass

class IRISConnection(_IRISConnection._IRISConnection):
    pass

class connect(_IRISConnection._IRISConnection):
    pass
