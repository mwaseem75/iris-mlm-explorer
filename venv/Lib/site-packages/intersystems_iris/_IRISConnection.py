...
class _IRISConnection():
    ...
    def __init__(self, *args, connectionstr = None, hostname = None, port = None,  namespace = None, username = None, password = None, timeout = None, sharedmemory = None, logfile = None, sslcontext = None, autoCommit=None, isolationLevel=None, featureOptions=None):
        ...
        isolationLevel = 1
        self._disable_output_redirect = True
        featureOptions = Feature.optionDefaultOptions if featureOptions == None else int(featureOptions)
        self._connect(hostname, port, namespace, username, password, timeout, sharedmemory, logfile, sslcontext, autoCommit, isolationLevel, featureOptions)
...
'''
    ...
    def _connect(self, hostname, port, namespace, username, password, timeout, sharedmemory, logfile, sslcontext, autoCommit, isolationLevel, featureOptions):
        ...
        if ((featureOptions & ~Feature.optionAllowedOptions) != 0):
        ...
        try:
            ...
            with self._lock:
                ...
                self._out_message.wire._write_header(self.MESSAGE_HANDSHAKE)
                ...
                self._out_message.wire._write_header(self.MESSAGE_CONNECT)
                # namespace
