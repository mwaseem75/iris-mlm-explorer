...
class _ListReader(object):
    ...
    def __init__(self, bufferarray, locale="latin-1"):
        self.list_item = iris._ListItem._ListItem(bufferarray)
        self._locale = locale
    ...
    def _get(self, asBytes=False, retainAsciiZero=False):
        iris._DBList._DBList._get_list_element(self.list_item)
        return iris._DBList._DBList._get(self.list_item, self._locale, asBytes, retainAsciiZero)
    ...
    def _get_raw_bytes(self, length):
        self.is_null = False
        self.list_item.type = iris._DBList._DBList.ITEM_PLACEHOLDER
    ...
    def _get_at_offset(self, offset, asBytes = False):
        ...
        iris._DBList._DBList._get_list_element(self.list_item)
        return iris._DBList._DBList._get(self.list_item, self._locale, asBytes)
    ...
    def _next(self):
        return iris._DBList._DBList._get_list_element(self.list_item)
