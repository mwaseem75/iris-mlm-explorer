...
class _DBList(object):
    ...
    def _grab_oref_ascii(cls, buffer, offset, length, locale, *args):
        return iris._IRISOREF._IRISOREF(cls._grab_ascii_string(buffer, offset, length, locale, False))

    @classmethod
    def _grab_oref_unicode(cls, buffer, offset, length, *args):
        return iris._IRISOREF._IRISOREF(cls._grab_unicode_string(buffer, offset, length))
    ...
    def _stuff_str(cls, buffer, offset, data, locale, is_unicode, *args):
        ...
        is_oref = False
        if type(data) == iris._IRISOREF._IRISOREF:
            data = data._oref
            is_oref = True
        offset_saved = offset
...
_DBList._set_switcher = {
    ...
    iris._IRISOREF._IRISOREF: _DBList._stuff_str,
}
